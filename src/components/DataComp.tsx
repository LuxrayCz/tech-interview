...
const DataComp = ({
  ...
  return (
    <div>
      {/* SHOW DATA */}
      <div
        className={`grid grid-cols-12 place-items-center py-2 text-white  text-center space-x-10 ${
      ...
      {oneComp.children.has_nemesis && isChildrenShown ? (
        <div className="ml-10 w-full  mb-3">
          <div className="max-w-2xl">
            <div
              className={`grid grid-cols-6 place-items-center py-2 text-black font-bold  text-center space-x-10 bg-green-600 `}
            >
              <div />
              <p>ID</p>
              <p>Character_Id</p>
